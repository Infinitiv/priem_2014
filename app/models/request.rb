    ...
    root.Applications do |as|
      applications.each do |am|
        as.Application do |a|
          ...
          a.RegistrationDate am.registration_date.to_datetime.to_s.gsub('+00', '+03')
          a.LastDenyDate am.last_deny_day.to_datetime.to_s.gsub('+00', '+03') if am.last_deny_day
    ...
    root.OrdersOfAdmission do |ooas|
      as.each do |a|
        ooas.OrderOfAdmission do |ooa|
          ...
          ooa.Stage stage if stage && finance_source == 14
