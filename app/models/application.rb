...
class Application < ActiveRecord::Base
  ...
  def self.ege_to_txt(applications)
    ...
    applications.each do |application|
      ege_to_txt += "#{[application.entrant_last_name, application.entrant_first_name, application.entrant_middle_name].join('%')}%#{[application.identity_documents.last.identity_document_series, application.identity_documents.last.identity_document_number].compact.join('%')}\r\n"
    end
